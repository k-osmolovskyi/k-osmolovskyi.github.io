...
| --- | -------------------------------------------------------------- | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| 1   | **[Structural Updating and the Limits of Cognitive Change](https://doi.org/10.5281/zenodo.19545677)**                     | Theoretical entry point to the series                         | Shows that access to processing should be distinguished from the availability of structural updating, and introduces admissibility of structural updating. | **Structural updating** |
